...
<?php
	...
	if(!empty($_POST))
	{
			...
			$query="call actualizar_bici_infantil('".$id_producto."','".$precio."','".$color."',
	...
	if(empty($_REQUEST['id_producto']))
	{
		...
		$query=mysqli_query($conexion,"call actualizar_bici_infantil_id('".$id_producto."')") or die("");
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Editar <b>Bicicleta infantil</b></h2></div>
                    <!-- <div class="col-sm-4">
