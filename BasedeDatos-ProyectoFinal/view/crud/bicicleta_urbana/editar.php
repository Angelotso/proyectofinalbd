...
<?php
	...
	if(!empty($_POST))
	{
			...
			$query="call actualizar_bici_urbana('".$id_producto."','".$precio."','".$color."',
			'".$material."', '".$objeto_extra."','".$imgProducto."')";
			$query_update= mysqli_query($conexion,$query) or die ("error");
			if($query_update){

				if($nombre_foto != '' && ($_POST['foto_actual']!='/img/images.jpg') || ($_POST['foto_actual'] != $_POST['foto_remove']))
				{
	...
	if(empty($_REQUEST['id_producto']))
	{
		...
		$query=mysqli_query($conexion,"call actualizar_bici_urbana_id('".$id_producto."')") or die("");
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Editar <b>Bicicleta Urbana</b></h2></div>
                    <!-- <div class="col-sm-4">
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<input type="text" name="objeto_extra" id="objeto_extra" class='form-control' maxlength="64" required value="<?php echo $data_producto['objeto_extra'];?>">
				</div>
