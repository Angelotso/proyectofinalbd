...
<?php
    ...
    $class="";
        ...
        if(!empty($_POST)){
            ...
            if(empty($_POST['id_producto']) || empty($_POST['precio']) || empty($_POST['color']) || empty($_POST['material']))
            {
                ...
                $cons = "CALL insertar_bicicleta_freestyle('".$id_producto."','".$precio."',
				'".$color."','".$material."','".$imgProducto."')";
